...
const BODY = [
  ...
  "raw/_inbox/",
  "# An unpacked archive (plan 6.1) is thousands of files nobody chose to commit.",
  "# The archive beside it *is* committed and is the thing that actually arrived,",
  "# so the tree is a reading convenience `ow` can produce again from it. The case",
  "# worth opting in for is a codewiki page citing into the tree, where the",
  "# citations have to resolve for everyone — negate it below the closing marker.",
  "raw/**/contents/",
  "#",
