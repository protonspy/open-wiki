...
- [x] 2.1 (Unit) The titlebar: the project's name, the recording indicator with its elapsed time and its pause, resume and stop controls, the record button, and the way into settings — R3.1, R3.2, R3.3, R3.4, R3.5
